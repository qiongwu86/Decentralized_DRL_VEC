...
for k in range(10):
    ...
    IS_TRAIN = False
#     rate = 3.0
    res_path = 'train_M_dqn_rate_2_lane3/pretrainstep50000/'
    model_fold = 'model_M_dqn_rate_2_lane3/pretrainstep50000/'
    model_path = 'model_M_dqn_rate_2_lane3/pretrainstep50000/my_train_model_rate2'+str(k)+'-2000'
    ...
    name = res_path+'test_1000_rate_2' + time.strftime("%b_%d_%Y_%H_%M_%S", time.localtime(time.time()))
