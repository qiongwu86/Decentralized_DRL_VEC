...
for k in range(1,10):
    ...
    train_config = {'minibatch_size':64, 'actor_lr':0.00005, 'tau':0.001, 
    ...
    res_path = 'train_S_ddpg_sigma0_02_rate3__actlr_0_00005__lane2/'
    model_fold = 'model_S_ddpg_sigma0_02_rate3__actlr_0_00005_lane2/'
    model_path = 'model_S_ddpg_sigma0_02_rate3__actlr_0_00005_lane2/my_train_model_rate_3_' + str(k) + '-2000'
