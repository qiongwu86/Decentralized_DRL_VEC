...
for k in range(15):
    ...
    IS_TRAIN = False
#     rate = 3.0
    res_path = 'train_M_dqn_rate_2_lane1/pretrainstep50000/'
    model_fold = 'model_M_dqn_rate_2_lane1/pretrainstep50000/'
    model_path = 'model_M_dqn_rate_2_lane1/my_train_model_rate2_'+str(k)+'-2000'
    ...
    #                 'data_buf_size':100, 't_factor':t_factor, 'penalty':1000, 'action_level':5}]
    user_config = [{'id':'1', 'model':'AR', 'num_r':NUM_R, 'rate':3.0,   
                'data_buf_size':100, 't_factor':t_factor, 'penalty':1000,'lane':1.0},
               {'id':'2', 'model':'AR', 'num_r':NUM_R, 'rate':3.0,  
                'data_buf_size':100, 't_factor':t_factor, 'penalty':1000,'lane':2.0},
               {'id':'3', 'model':'AR', 'num_r':NUM_R, 'rate':3.0, 
                'data_buf_size':100, 't_factor':t_factor, 'penalty':1000,'lane':3.0},
               {'id':'4', 'model':'AR', 'num_r':NUM_R, 'rate':3.0, 
                'data_buf_size':100, 't_factor':t_factor, 'penalty':1000,'lane':1.0},
               {'id':'5', 'model':'AR', 'num_r':NUM_R, 'rate':3.0,
                'data_buf_size':100, 't_factor':t_factor, 'penalty':1000,'lane':2.0},
               {'id':'6', 'model':'AR', 'num_r':NUM_R, 'rate':3.0,
                'data_buf_size':100, 't_factor':t_factor, 'penalty':1000,'lane':3.0}]
    ...
    train_config = {'minibatch_size':64, 'actor_lr':0.0001, 'tau':0.001, 
                    ...
                    'action_level':5, 'action_bound':2, 'num_user': len(user_config)}
