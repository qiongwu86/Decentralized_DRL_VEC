...
class MecTerm(object):
    ...
    def sampleCh(self):
        self.Channel = self.channelModel.sampleCh(self.dis,self.lane)
        return self.Channel
...
class MecTermGD(MecTerm):
    ...
    def offloadDo(self, data):
        ...
        # np.log2(1 + self.action_bound*self.SINR)*self.t*self.bandwidth*1000
