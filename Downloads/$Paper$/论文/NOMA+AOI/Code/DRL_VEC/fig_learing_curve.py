...
plt.plot(range(ddpg_reward_S.shape[0]), ddpg_reward_S, color='#1f77b4', label='single user' )
plt.plot(range(ddpg_reward_M.shape[0]), ddpg_reward_M, color='#ff7f0e', label = 'multiple user')
