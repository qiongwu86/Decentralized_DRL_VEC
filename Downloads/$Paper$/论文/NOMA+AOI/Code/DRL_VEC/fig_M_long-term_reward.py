...
print(long_term_disc_reward(ddpg_reward))
print(long_term_disc_reward(GD_local_reward))
print(long_term_disc_reward(GD_offload_reward))


name = ["Polices for Multi-user "]
