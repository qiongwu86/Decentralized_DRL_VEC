...
for k in range(1,10):
    ...
    train_config = {'minibatch_size':64, 'actor_lr':0.00001, 'tau':0.001, 
                    'critic_lr':0.0001, 'gamma':0.99, 'buffer_size':250000, 
                    'random_seed':int(time.perf_counter()*1000%1000), 'noise_sigma':noise_sigma, 'sigma2':SIGMA2}

    IS_TRAIN = False

    res_path = 'train_S_ddpg_sigma0_001_rate3__actlr_0_00001_critic_0.0001_lane2/'
    model_fold = 'model_S_ddpg_sigma0_0001_rate3__actlr_0_00001_critic_0.0001_lane2/'
    model_path = 'model_S_ddpg_sigma0_0001_rate3__actlr_0_00001_critic_0.0001_lane2/my_train_model_rate_3_' + str(k) + '-2000'
    ...
    user_config = [{'id':'1', 'model':'AR', 'num_r':NUM_R, 'rate':3.0, 'action_bound':1, 
                    'data_buf_size':100, 't_factor':t_factor, 'penalty':20,'lane':2.0}]
