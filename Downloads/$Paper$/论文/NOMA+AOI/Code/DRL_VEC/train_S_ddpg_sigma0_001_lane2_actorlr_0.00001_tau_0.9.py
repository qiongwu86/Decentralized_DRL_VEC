...
for k in range(1,10):
    ...
    res_path = 'train_S_ddpg_sigma0_001_rate3__actlr_0_00001__lane2/'
    model_fold = 'model_S_ddpg_sigma0_0001_rate3__actlr_0_00001_lane2/'
    model_path = 'model_S_ddpg_sigma0_0001_rate3__actlr_0_00001_lane2/my_train_model_rate_3_' + str(k) + '-2000'
