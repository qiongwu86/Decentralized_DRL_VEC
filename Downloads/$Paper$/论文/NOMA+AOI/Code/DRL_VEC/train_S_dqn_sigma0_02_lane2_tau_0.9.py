...
for k in range(1,10):
    ...
    res_path = 'train_S_dqn_sigma0_02_rate3_lane2/'
    model_fold = 'model_S_dqn_sigma0_02_rate3_lane2/'
    model_path = 'model_S_dqn_sigma0_02_rate3_lane2/my_train_model_rate_3_' + str(k) + '-2000'
    ...
    user_config = [{'id':'1', 'model':'AR', 'num_r':NUM_R, 'rate':3.0, 'action_bound':1, 
                    'data_buf_size':100, 't_factor':t_factor, 'penalty':5, 'lane':2.0, 'action_level':5}]
