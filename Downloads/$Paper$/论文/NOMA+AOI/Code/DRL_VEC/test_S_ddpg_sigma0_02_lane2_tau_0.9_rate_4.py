...
for k in range(2,3):
    ...
    res_path = 'test_S_ddpg_sigma0_02_rate'+str(k)+'_lane2/'
    step_result_path = res_path + 'step_result/'
    model_fold = 'model_S_ddpg_sigma0_02_rate3_lane2/'
    model_path = 'model_S_ddpg_sigma0_02_rate3_lane2/my_train_model_rate_3_' + '5' + '-2000'
    ...
    user_config = [{'id':'1', 'model':'AR', 'num_r':NUM_R, 'rate':k, 'action_bound':2, 
